...
<template>
  <div class="quest-modal gap gap--page" v-if="setup.quest">
    ...
    <Select label="Categorie(s)" :options="setup.userDomainOptions.value" option-key="id" option-label="domain" option-value="domain" v-model="setup.quest.domain" placeholder="Ajoutez une catégorie"/>
